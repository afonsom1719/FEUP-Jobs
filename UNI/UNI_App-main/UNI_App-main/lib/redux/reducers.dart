...
AppState setJobFilter(AppState state, SetJobFilter action) {
  Logger().i('setting job filters to ' + action.jobFilters.toString());
  return state.cloneAndUpdateValue('jobFilters', action.jobFilters);
}
