...
| **Postconditions**                   | - The actor is able to scroll through the job bank listing <br>- The authenticated user gets access to another use case (use case 2)<br>- The authenticated user can now access individual listings|
