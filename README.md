...
| **Use Case**                         | **1**                                                                                                                                                                                                                        |
| :----------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Name**                             | View all job listings on FEUP's job bank                                                                                                                                                                                          |
...
| **Alternative Flows and Exceptions** | 1. The user is not authenticated and can view the listing but not interact with it                                                                                                                                            |
...
| Use Case                             | 3                                                                                                                                                                                                                       |
| :----------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Name**                             | View a full job's listing                                                                                                                                                                                                  |
| **Actors**                           | Authenticated User                                                                                                                                                                                                      |
...
| **Preconditions**                    |- The authenticated user must be logged in, using his credentials (user and password)  <br> - Be able to see a full jobs listing                                                                                                                                                                  |
...
| **Normal Flow**                      | 1. The authenticated user logs into the app with FEUP's credentials <br> 2. Opens the menu <br> 3. Selects the jobs listing option <br> 4. The system shows the job bank <br> 5. The user selects the job to which he wishes to get more details <br> 6. The authenticated user chooses to contact the employer |
...
| Use Case                             | 5                                                                                                                                                                                                  |
| :----------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Name**                             | View all open job positions at FEUP                                                                                                                                                                 |
| **Actors**                           | Authenticated User, Regular User                                                                                                                                                                   |
| **Description**                      | The user can view a page displaying all the job positions currently open at FEUP, with a brief description of each.                                                                                 |
...
| Use Case                             | 6                                                                                                                                                                                                                                                                                                                                                                                               |
| :----------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Name**                             | View a full job listing for a job at FEUP                                                                                                                                                                                                                                                                                                                                                        |
| **Actors**                           | Authenticated User, Regular User                                                                                                                                                                                                                                                                                                                                                                |
