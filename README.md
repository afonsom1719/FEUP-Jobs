...
| **Postconditions**                   | - The actor is able to scroll through the jobs bank listing <br>- The authenticated user gets access to another use case (use case 2)<br>- The authenticated user can now access individual listings|
| **Normal Flow**                      | 1. The authenticated user logs into the app with FEUP's credentials <br> 2. Opens the menu <br> 3. Selects the jobs listing option <br> 4. The system shows the listings available in FEUP's jobs bank <br> 5. Further actions can be taken from there    |
...
| **Preconditions**                    |- The authenticated user must have a valid identification as well as a working password on Sigarra <br> - Be able to see a full job listing                                                                                                                                                                  |
| **Postconditions**                   | - The authenticated user gets access to the company contacts info and is able to contact them directly <br>- The authenticated user becomes allowed to apply to the job                                                                                                                                     |
| **Normal Flow**                      | 1. The authenticated user logs into the app with FEUP's credentials <br> 2. Opens the menu <br> 3. Selects the jobs listing option <br> 4. The system shows the jobs bank <br> 5. The user selects the job to which he wishes to see details <br> 6. The authenticated user chooses to contact the employer |
...
| **Normal flow**                      | 1. The user accesses the app page that contains the job listings at FEUP<br> 2. The app shows all the listings available at FEUP that are available <br> 3. The user selects a specific job <br> 4. More detailed information about the job listing is displayed|
| **Alternative flows and exceptions** | 1. If there is no information to be shown, an error message is displayed                                                                                                                                                                                                                                                                        |
